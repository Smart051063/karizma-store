  ...
  return (
    <footer style={{ backgroundColor: '#111', color: '#fff', padding: '60px 20px 20px', direction: 'rtl', fontFamily: 'Arial, sans-serif', borderTop: '4px solid #d4af37' }}>
      ...
      <div style={{ maxWidth: '1200px', margin: '0 auto', display: 'flex', flexWrap: 'wrap', gap: '40px', justifyContent: 'space-between' }}>
        ...
        {/* 1️⃣ العمود الأول: عن البراند والسوشيال ميديا */}
        <div style={{ flex: '1 1 300px' }}>
          ...
          <div style={{ display: 'flex', gap: '15px' }}>
            <SocialIcon href="https://www.fahttps://www.facebook.com/people/Karizma-Fragrances-%D9%83%D8%A7%D8%B1%D9%8A%D8%B2%D9%85%D8%A7-%D9%84%D9%84%D8%B9%D8%B7%D9%88%D8%B1/61561267272083/?rdid=KTA90WOLVXNozkgG&share_url=https%3A%2F%2Fwww.facebook.com%2Fshare%2F17s7Ue16en%2Fcebook.com" path={icons.facebook} color="#1877F2" />
            ...
            <SocialIcon href="https://www.tiktok.comhttps://www.tiktok.com/@karizma.fragrance?is_from_webapp=1&sender_device=pc" path={icons.tiktok} color="#000000" hoverColor="#fff" />
